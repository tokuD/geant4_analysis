...
void drawHitpattern(int run) {
  ...
  TH2D *histHitPattern0 =
      new TH2D("hist0", ";x [mm]; y[mm]", 100, -600, 600, 100, -600, 600);
  setHist(histHitPattern0);
  TH2D *histHitPattern1 =
      new TH2D("hist1", ";x [mm]; y[mm]", 100, -600, 600, 100, -600, 600);
